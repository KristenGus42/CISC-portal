          ...
          <div className="col-10">
            <div className="row g-4">
              ...
              <div className="col-3">
                ...
                <input type="text" className="form-control" id="householdSize" name="householdSize" value={clientFormData.householdSize} onChange={handleClientChange} />
              </div>
              <div className="col-3">
              ...
              <div className="col-6">
                ...
                <input type="text" className="form-control" id="address" name="address" value={clientFormData.address} onChange={handleClientChange} />
              </div>
              <div className="col-3">
              ...
              <div className="col-3">
                ...
                <input type="text" className="form-control" id="secondaryLanguage" name="secondaryLanguage" value={clientFormData.secondaryLanguage} onChange={handleClientChange} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-10">
            <div className="row g-4">
              ...
              <div className="col-9">
                ...
                <textarea className="form-control" id="description" name="description" value={caseFormData.description} onChange={handleCaseChange} rows={3} />
              </div>
            </div>
          </div>
        </div>
